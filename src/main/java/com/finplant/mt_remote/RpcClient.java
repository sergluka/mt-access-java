...
import com.finplant.mt_remote.dto.common.Request;
import com.finplant.mt_remote.dto.common.Subscription;
import com.finplant.mt_remote.dto.jackson.BytesMapping;
import com.finplant.mt_remote.dto.jackson.LocalDateTimeMapping;
import com.finplant.mt_remote.dto.jackson.MonthMapping;
import com.finplant.mt_remote.dto.jackson.ZoneOffsetMapping;
...
public class RpcClient implements AutoCloseable {
    ...
    private void handleResponseIfExists(JsonNode json) {
        ...
        if (!status.equals("OK")) {
            ...
            if (message == null) {
                request.onError(new Errors.MtRemoteError("Missing 'message' in error response"));
                return;
            }

            request.onError(new Errors.MtRemoteError(message.asText()));
            return;
        }

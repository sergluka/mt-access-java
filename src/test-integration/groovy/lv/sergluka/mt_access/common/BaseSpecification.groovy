package lv.sergluka.mt_access.common
...
abstract class BaseSpecification extends Specification {
    ...
    protected static final URI MT_ACCESS_URL = URI.create("wss://localhost:12344")
    ...
    private static final def params = MtAccessClient.ConnectionParameters.builder()
            .uri(MT_ACCESS_URL)
            .server(MT_URL)
            .login(MT_LOGIN)
    ...
    @Subject
    @AutoCleanup
    protected MtAccessClient client = createClient()
